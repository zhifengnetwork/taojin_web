    ...
    <div class="height-88 public_bg">
        ...
        <div class="currency">
            <div class="currency_wrap">
                <img class="currency_img" src="https://taojin-zhifeng.oss-cn-shenzhen.aliyuncs.com/static/images/currency.png">
                <span>{{user_info.currency}}</span>
                <p>币</p>
            </div>
            <div class="currency_wrap">
                <img class="currency_img" src="https://taojin-zhifeng.oss-cn-shenzhen.aliyuncs.com/static/images/user/currency.png">
