<template>
   <div class="height-88 balance_detailed">
        <!-- 头部组件 back-url=>反回路径，默认返回上一页 title=>标题内容 fixed=>是否固定在顶部 rgb=>背景色 col=>字体颜色 -->
		<TopHeader back-url="" custom-title="充值明细" :custom-fixed="true" custom-rgb custom-col>
			<!-- 返回按钮 -->
...
<script>
    ...
    export default {
        ...
        methods:{
            initalize(){
                let _this = this;
                this.$axios.post('index/recharge_balance_detailed',{
